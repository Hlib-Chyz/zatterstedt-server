...
import { CanSaveInventoryDto, CanSaveInventoryResponseDto, CreateManufacturingCostDto, ManufacturingCostInventoryDto, ManufacturingCostJobDto } from 'src/dto/manufacturing-cost.dto';
...
export declare class ManufacturingCostsService {
    ...
    constructor(manufacturingCostsRepository: Repository<ManufacturingCost>, errorService: ErrorService, inventoryService: InventoryService, ordersService: OrdersService);
    ...
    addInventory(_id: ObjectId, manufacturingCostInventory: ManufacturingCostInventoryDto): Promise<SuccessDto>;
