    ...
    async changeInventoryAmount(inventory, negative) {
        for (const inv of inventory) {
            if (inv.duringManufacture) {
                await this.inventoryService.changeInventoryAmount(inv.inventoryId, negative ? -inv.quantityInUse : inv.quantityInUse, negative ? -inv.quantityInCost : inv.quantityInCost);
            }
        }
    }
};
...
exports.ManufacturingCostsService = ManufacturingCostsService = tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, typeorm_1.InjectRepository)(manufacturing_cost_entity_1.ManufacturingCost)),
