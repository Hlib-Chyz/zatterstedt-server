...
exports.ManufacturingCostSchema = exports.ManufacturingCost = exports.InventorySchema = exports.InventoryItem = exports.JobSchema = exports.Job = void 0;
...
exports.Job = Job = tslib_1.__decorate([
    (0, mongoose_1.Schema)()
], Job);
...
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, required: true, unique: true, ref: inventory_schema_1.Inventory.name }),
    tslib_1.__metadata("design:type", mongoose_2.Types.ObjectId)
], InventoryItem.prototype, "inventoryId", void 0);
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: Number, required: true }),
    tslib_1.__metadata("design:type", Number)
], InventoryItem.prototype, "quantityInCost", void 0);
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: Number, required: true }),
    tslib_1.__metadata("design:type", Number)
], InventoryItem.prototype, "quantityInUse", void 0);
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: Boolean, required: true }),
    tslib_1.__metadata("design:type", Boolean)
], InventoryItem.prototype, "duringManufacture", void 0);
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: Number, required: true }),
    tslib_1.__metadata("design:type", Number)
], InventoryItem.prototype, "cost", void 0);
exports.InventoryItem = InventoryItem = tslib_1.__decorate([
    (0, mongoose_1.Schema)()
], InventoryItem);
exports.InventorySchema = mongoose_1.SchemaFactory.createForClass(InventoryItem);
let ManufacturingCost = class ManufacturingCost {
};
exports.ManufacturingCost = ManufacturingCost;
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, required: true, unique: true, ref: product_schema_1.Product.name }),
    tslib_1.__metadata("design:type", mongoose_2.Types.ObjectId)
], ManufacturingCost.prototype, "productId", void 0);
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: [exports.JobSchema], default: [] }),
    tslib_1.__metadata("design:type", Array)
], ManufacturingCost.prototype, "job", void 0);
tslib_1.__decorate([
    (0, mongoose_1.Prop)({ type: [exports.InventorySchema], default: [] }),
    tslib_1.__metadata("design:type", Array)
